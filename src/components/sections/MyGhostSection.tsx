...
import { Ghost, Brain, Eye, Heart, ArrowRight, CheckCircle, Smartphone, Shield } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Persistent AR companion that follows you, learns from your interactions, and provides personalized assistance.
          </p>
        ...
        <div className="bg-gradient-to-br from-pink-500/10 to-rose-500/10 border border-pink-500/20 rounded-2xl p-12 mb-20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Your Persistent AR Companion</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              My Ghost is always with you, learning from your daily interactions and environment to become the perfect personal assistant.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black/20 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">See your Ghost through your mobile device camera</p>
            </div>
            <div className="bg-black/20 rounded-xl p-6 text-center">
              <Brain className="w-12 h-12 text-purple-400 mx-auto mb-4" />
              <h3 className="text-white font-semibold mb-2">Continuously Learning</h3>
              <p className="text-gray-400 text-sm">Adapts to your preferences and habits</p>
            </div>
            <div className="bg-black/20 rounded-xl p-6 text-center">
              <Heart className="w-12 h-12 text-red-400 mx-auto mb-4" />
              <h3 className="text-white font-semibold mb-2">Emotionally Aware</h3>
              <p className="text-gray-400 text-sm">Responds to your mood and emotional state</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/20 rounded-2xl p-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Learns from Interactions & Environment</h3>
            <p className="text-gray-300 mb-6">
              Your Ghost observes your daily routines, preferences, and environment to provide increasingly personalized assistance.
            </p>
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Visible Through Mobile Device Camera</h3>
            <p className="text-gray-300 mb-6">
              See and interact with your Ghost through your smartphone or tablet camera, making it a natural part of your daily life.
            </p>
            <ul className="space-y-3">
              <li className="flex items-center text-gray-300">
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Personalized Assistance Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Reminds you of appointments and important events</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Guides you to destinations and suggests routes</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Recommends activities based on your interests</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center">
              ...
              <h3 className="text-white font-semibold mb-2">Emotional Support</h3>
              <p className="text-gray-400 text-sm">Provides companionship and emotional assistance</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-2xl p-12 mb-20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">User-Controlled Visibility & Behavior</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              You have complete control over when and how your Ghost appears, ensuring privacy and comfort in all situations.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-white">Visibility Controls</h3>
              <ul className="space-y-3">
                <li className="flex items-center text-gray-300">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-white">Behavior Settings</h3>
              <ul className="space-y-3">
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
        ...
        <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-2xl p-12 mb-20">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">Adaptive Learning Capabilities</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Your Ghost becomes more helpful over time, learning from every interaction to better understand and assist you.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">Watches your daily patterns and interactions</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-4 mx-auto">
                2
              ...
              <p className="text-gray-400">Processes information to understand preferences</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-4 mx-auto">
                3
              ...
              <p className="text-gray-400">Adjusts behavior to better serve your needs</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-pink-500/10 to-rose-500/10 border border-pink-500/20 rounded-2xl p-12">
            <h2 className="text-3xl font-bold text-white mb-4">Get Your Personal AI Companion</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Experience the future of personal assistance with My Ghost - your intelligent, adaptive AR companion.
            </p>
