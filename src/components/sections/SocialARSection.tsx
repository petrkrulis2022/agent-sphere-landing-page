      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Bridge physical and digital worlds. Students deploy AI agents on
            campus for hybrid human-AI interactions.
          </p>
        ...
        <div className="mb-20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Social AR Network Videos
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Exciting video demonstrations of our Social AR Network features
              are currently in production. Check back soon to see hybrid
              human-AI interactions in action!
            </p>
          </div>

          <div className="max-w-6xl mx-auto bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-16 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              Video Content In Development
            </h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              We're creating comprehensive video demonstrations showcasing
              campus agent deployments, hybrid social interactions, live
              streaming features, and privacy-protected avatar experiences.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm text-blue-400">
              <span className="bg-blue-500/20 px-3 py-1 rounded-full">
                Campus Deployment Demos
              </span>
              <span className="bg-blue-500/20 px-3 py-1 rounded-full">
                Live Streaming Features
              </span>
              <span className="bg-blue-500/20 px-3 py-1 rounded-full">
                Avatar Privacy Systems
              </span>
              <span className="bg-blue-500/20 px-3 py-1 rounded-full">
                Auras Currency Usage
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-12 mb-20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Students Deploy AI Agents on Campus
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Transform your campus into a hybrid social space where AI agents
              interact with students in real-world locations.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black/20 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">
                AI tutors stationed in library locations
              </p>
            </div>
            <div className="bg-black/20 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">
                AI agents capturing campus moments
              </p>
            </div>
            <div className="bg-black/20 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">
                Emergency response and guidance agents
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-violet-500/10 border border-purple-500/20 rounded-2xl p-8">
            ...
            <p className="text-gray-300 mb-6">
              Seamless conversations between students and AI agents in physical
              spaces, creating new forms of social interaction.
            </p>
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-2xl p-8">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              Live Streaming with Agent Takeover
            </h3>
            <p className="text-gray-300 mb-6">
              Stream your campus experiences while AI agents can take over to
        ...
        <div className="bg-gradient-to-br from-pink-500/10 to-rose-500/10 border border-pink-500/20 rounded-2xl p-12 mb-20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Avatar-Based Privacy Protection
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Maintain your privacy while engaging socially through customizable
              avatars and controlled visibility settings.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-2xl p-12 mb-20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Blockchain-Based Auras Currency
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Earn and spend Auras for social interactions, agent services, and
              premium features within the network.
            </p>
          </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-12">
            <h2 className="text-3xl font-bold text-white mb-4">
              Join the Social AR Revolution
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Connect with humans and AI agents in a new kind of social network
